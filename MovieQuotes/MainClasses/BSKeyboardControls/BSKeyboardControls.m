...
- (id) initWithFields : (NSArray *) fields
{
    if (self = [super initWithFrame : CGRectMake(0.0f, 0.0f, 320.0f, 44.0f)])
    {
        ...
        [self.segmentedControl setEnabled        : NO
                               forSegmentAtIndex : BSKeyboardControlsDirectionNext];
...
- (void) setPreviousTitle : (NSString *) previousTitle
{
    ...
    {
        [self.segmentedControl setTitle          : previousTitle
                               forSegmentAtIndex : BSKeyboardControlsDirectionPrevious];
...
- (void) setNextTitle : (NSString *) nextTitle
{
    ...
    {
        [self.segmentedControl setTitle          : nextTitle
                               forSegmentAtIndex : BSKeyboardControlsDirectionNext];
...
- (void) selectPreviousField
{
    ...
    if (index > 0)
    {
        ...
        {
            [self.delegate keyboardControls : self
                           selectedField    : field
                           inDirection      : BSKeyboardControlsDirectionPrevious];
        }
    }
}
